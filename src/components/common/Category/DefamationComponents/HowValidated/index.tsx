...
export const HowValidated = () => {
  return (
    <>
      <S.HowValidatedTitle>사이버 명예훼손죄가 성립되려면?</S.HowValidatedTitle>
      <S.HowValidatedSetContainer>
        <S.HowValidatedContainer>
          <S.HowValidatedCard>
            <S.HowValidatedIcon
              src={
            ...
            />
            <S.HowValidatedCardTitle>공연성</S.HowValidatedCardTitle>
            <S.HowValidatedCardText>
          ...
          <S.HowValidatedCard>
            ...
            />
            <S.HowValidatedCardTitle>비방할 목적</S.HowValidatedCardTitle>
            <S.HowValidatedCardText>
              피해자를 불이익하게 할
              <br /> 일체의 목적을 말한다.
            </S.HowValidatedCardText>
